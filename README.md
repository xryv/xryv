...
<p align="center">
  <img
    src="https://skillicons.dev/icons?i=html,css,js,mysql,ts,nodejs,express,react,tailwind,bootstrap,php,symfony,wordpress,svg,postgres,sqlite,linux,windows,powershell,bash,git,github,githubactions,npm,yarn,vscode,postman,firebase,docker,discord,figma,ai,bots,autocad,ableton,ps,fontawesome&perline=12&theme=light"
    alt="tech stack"
  />
</p>
